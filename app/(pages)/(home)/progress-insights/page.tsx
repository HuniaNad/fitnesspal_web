            ...
            <div
                ...
                <div className={"flex flex-row items-center justify-between w-full "}>
                    ...
                    <div className={"w-full flex flex-col gap-6 items-center justify-center"}>
                        <h1>{handleBMIStatus(healthProfile.bmi)}</h1>
                        <div className={"flex flex-row items-center justify-between w-4/5"}>
                            <h1>Current BMI</h1>
                            <h1>{healthProfile.bmi} kg/m<sup>2</sup></h1>
                        </div>
                        <div className={"flex flex-row items-center justify-between w-4/5"}>
                            <h1>Healthy BMI Range</h1>
                            <h1>18.5 kg/m<sup>2</sup> - 24.9 kg/m<sup>2</sup></h1>
                        </div>
                        <div className={"flex flex-row items-center justify-between w-4/5"}>
                            <h1>Healthy Weight for Height</h1>
                            <h1>47.4 kg - 64 kg</h1>
                        </div>
                    </div>
                </div>
